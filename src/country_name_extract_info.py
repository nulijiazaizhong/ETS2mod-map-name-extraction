...
# 示例调用
directory_path = r'F:\map_country_names_location\def\country'  # 替换为你的文件夹路径
character = 'name: "@@'  # 设置为要查找的字符
output_file_path = r'F:\map_country_names_location\country_name_output1.sii'  # 替换为你想保存输出的文件路径,支持.txt和.sii格式
